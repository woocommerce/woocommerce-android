...
DEPRECATED_ALIASES = {
    ...
    "MAESTRO_WOO_SHARED_STORE_URL": "MAESTRO_WOO_SHARED_JETPACK_STORE_URL",
    "MAESTRO_WOO_SHARED_EMAIL": "MAESTRO_WOO_SHARED_WPCOM_EMAIL",
    "MAESTRO_WOO_SHARED_PASSWORD": "MAESTRO_WOO_SHARED_WPCOM_PASSWORD",
