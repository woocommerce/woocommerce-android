...
# This script aims to rename any `.apk` or `.aab` file to `[wcandroid]-{version}[-Signed].apk/aab`
...
# versionCode and doesn't distinguish from a binary corresponding to WooCommerce.
#
