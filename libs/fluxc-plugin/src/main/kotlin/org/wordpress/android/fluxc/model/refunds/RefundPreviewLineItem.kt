...
/**
 * Per-line item for the refund preview endpoint (`POST /wc/v3/orders/<order_id>/refunds/preview`).
 *
...
data class RefundPreviewLineItem private constructor(
    ...
    companion object {
        ...
        fun quantityBased(lineItemId: Long, quantity: Int) =
            RefundPreviewLineItem(lineItemId = lineItemId, quantity = quantity)
        ...
        fun amountBased(lineItemId: Long, refundTotal: BigDecimal) =
            RefundPreviewLineItem(lineItemId = lineItemId, refundTotal = refundTotal)
    }
}
