...
class WooCommerceStoreTest {
    ...
    @Test
    fun `when fetch analytics order date type fails, then the error is returned`() = test {
    ...
    @Test
    fun `when fetch analytics order date type succeeds, then the success is returned`() = test {
    ...
    @Test
    fun `when update analytics order date type succeeds, then the success is returned`() = test {
