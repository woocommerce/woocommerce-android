package com.woocommerce.android.pos.analytics
...
import com.woocommerce.android.pos.analytics.WooPosAnalyticsEventConstant.ItemsHeaderType
...
import com.woocommerce.android.pos.analytics.WooPosAnalyticsEventConstant.SyncErrorType
import com.woocommerce.android.pos.analytics.WooPosAnalyticsEventConstant.SyncSkipReason
import com.woocommerce.android.pos.analytics.WooPosAnalyticsEventConstant.SyncType
...
sealed class WooPosAnalyticsEvent : IAnalyticsEvent {
    ...
    sealed class Event : WooPosAnalyticsEvent() {
        ...
        data class Loaded(val syncStrategy: String) : Event() {
        ...
        data class IneligibleUIShown(val reason: String) : Event() {
        ...
        data class IneligibleUIRetryTapped(val reason: String) : Event() {
