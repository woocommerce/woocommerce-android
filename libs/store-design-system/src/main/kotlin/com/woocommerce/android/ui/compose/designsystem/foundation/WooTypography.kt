...
internal val DefaultWooTypography = WooTypography(
    ...
    headlineSmall = textRole(size = 24, lineHeight = 32, letterSpacing = -1.00f),
    ...
    bodyMedium = textRole(size = 15, lineHeight = 20, letterSpacing = -0.41f),
...
internal val LocalWooText = staticCompositionLocalOf<WooTypography> {
    error("WooTheme.text is not available. Wrap content in WooDesignSystemTheme.")
}
