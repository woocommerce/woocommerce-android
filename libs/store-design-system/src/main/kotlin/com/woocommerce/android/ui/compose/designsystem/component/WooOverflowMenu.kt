 ...
 *
 * For top app bar actions prefer [WooTopAppBarActionsScope.OverflowAction], which supplies the standard
 * vertical ellipsis trigger. Cards, banners, and list items keep the horizontal ellipsis.
 */
@Composable
fun WooOverflowMenu(
