...
- Build debug APK: `./gradlew assembleWasabiDebug`
...
| `test` | "run tests", "write tests", "fix tests" |
| `lint` | "run lint", "run detekt", "check style" |
| `debug` | "debug build", "fix build", "why is this failing" |
