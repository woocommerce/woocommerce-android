...
| Page Header | `WooPageHeader`, `WooPageHeaderScrollBehavior`, `WooPageHeaderDefaults` | production | Parameter-controlled fixed 64dp and collapsible Material 3 medium modes with optional constrained right actions and a full-width bottom divider. |
