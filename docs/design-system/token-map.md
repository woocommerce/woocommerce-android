...
| `WooTheme.colors.container.secondaryContainer` | `Woo Theme/Secondary-Container` | `figma-export.json` | `#F2EDFF` / 100% | `#473B5B` / 100% | `secondaryContainer` | production | Opaque: light aliases `Colors.Purple.Purple 0`, dark is a literal. Earlier exports mapped this role to a 16% tint layer. The Android tab bar binds its background to this role. |
