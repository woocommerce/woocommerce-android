...
| Modal Bottom Sheet | `surface.bright` container; `surface.onVariantLowest` handle; no visible boundary | Production narrow wrapper. Material continues to own scrim, width, insets, gestures, focus, semantics, and platform behavior. |
