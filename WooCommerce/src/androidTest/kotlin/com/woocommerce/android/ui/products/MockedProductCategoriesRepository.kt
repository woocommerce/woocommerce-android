...
class MockedProductCategoriesRepository constructor(
    ...
    override suspend fun fetchProductCategories(pageSize: Int, loadMore: Boolean): List<ProductCategory> {
        return generateTestProductCategoriesAppModelList()
    }

    override suspend fun fetchAllProductCategories(): List<ProductCategory> {
        return generateTestProductCategoriesAppModelList()
    }
