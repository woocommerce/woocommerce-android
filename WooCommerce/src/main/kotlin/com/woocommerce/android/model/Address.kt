...
import com.woocommerce.android.ui.addressformatting.AdministrativeAreaAdapter.determineAreaForLibAddressInputLibrary
...
data class Address(
    ...
    private fun getAddressData(): AddressData {
        return AddressData.builder()
            ...
            .setLocality(city)
            .setAdminArea(determineAreaForLibAddressInputLibrary(country.code, state.asLocation()))
