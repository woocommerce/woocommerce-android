...
enum class AnalyticsEvent(val siteless: Boolean = false) {
    ...
    LOGIN_JETPACK_NO_MATCHED_SITE_ERROR_VIEWED(siteless = true),
    LOGIN_JETPACK_NO_MATCHED_SITE_ERROR_TRY_AGAIN_BUTTON_TAPPED(siteless = true),
    LOGIN_JETPACK_NO_MATCHED_SITE_ERROR_CONTACT_SUPPORT_BUTTON_TAPPED(siteless = true),
