...
enum class AnalyticsEvent(override val siteless: Boolean = false) : IAnalyticsEvent {
    ...
    LOGIN_QR_PROLOGUE_CAMERA_PERMISSION_DIALOG_SHOWN(siteless = true),
    LOGIN_QR_PROLOGUE_CAMERA_PERMISSION_PRIMARY_TAPPED(siteless = true),
    LOGIN_QR_PROLOGUE_CAMERA_PERMISSION_DISMISSED(siteless = true),
    ...
    LOGIN_QR_HELP_TAPPED(siteless = true),
