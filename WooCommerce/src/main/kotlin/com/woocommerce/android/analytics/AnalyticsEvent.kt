...
enum class AnalyticsEvent(override val siteless: Boolean = false) : IAnalyticsEvent {
    ...
    APPLICATION_VERSION_CHECK_FAILED,
    BACK_PRESSED,
    VIEW_SHOWN,
    ...
    SITE_PICKER_NON_WOO_SITE_TAPPED,
    SITE_PICKER_NEW_TO_WOO_TAPPED,
    SITE_PICKER_ADD_A_STORE_TAPPED,
    SITE_PICKER_SITE_DISCOVERY,
    SITE_PICKER_JETPACK_TIMEOUT_ERROR_SHOWN,
    SITE_PICKER_JETPACK_TIMEOUT_CONTACT_SUPPORT_CLICKED,
    SITE_PICKER_EDIT_BUTTON_SHOWN,
    SITE_PICKER_EDIT_BUTTON_TAPPED,
    SITE_PICKER_LIST_SAVE_BUTTON_TAPPED,
    SITE_PICKER_LIST_SAVING_SUCCESS,
    ...
    DASHBOARD_STATS_ORDER_DATE_TYPE_SELECTOR_TAPPED,
    DASHBOARD_STATS_ORDER_DATE_TYPE_SELECTED,
    DASHBOARD_STATS_ORDER_DATE_TYPE_UPDATE_FAILED,
    DASHBOARD_STATS_REVENUE_TYPE_SELECTED,
    ...
    DYNAMIC_DASHBOARD_CARD_DATA_LOADING_FAILED,
    ...
    CARD_READER_LOCATION_PERMISSION_REQUIRED_SHOWN,
    ...
    SETTINGS_PUSH_NOTIFICATIONS_BUTTON_TAP,
    ...
    PRODUCT_IMAGE_UPLOAD_RETRY_BUTTON_TAPPED,
    ...
    PRODUCT_IMAGE_REMOVE_BACKGROUND_BUTTON_TAPPED,
    PRODUCT_IMAGE_REMOVE_BACKGROUND_SAVE_BUTTON_TAPPED,
    PRODUCT_IMAGE_REMOVE_BACKGROUND_DISCARDED,
    PRODUCT_IMAGE_REMOVE_BACKGROUND_ERROR,
    ...
    SUPPORT_CHAT_ENTRY_POINT_TAPPED,
    SUPPORT_CHAT_ISSUE_SELECTED,
    SUPPORT_CHAT_TROUBLESHOOTING_COMPLETED,
    SUPPORT_CHAT_MESSAGE_SENT,
    SUPPORT_CHAT_RESPONSE_RECEIVED,
    SUPPORT_CHAT_FEEDBACK_SUBMITTED,
    SUPPORT_CHAT_ESCALATION_BUTTON_SHOWN,
    SUPPORT_CHAT_ESCALATION_TAPPED,
    SUPPORT_CHAT_TICKET_CREATED,
    SUPPORT_CHAT_TICKET_CREATION_FAILED,
    SUPPORT_CHAT_RESOLUTION_BUTTON_SHOWN,
    SUPPORT_CHAT_MARK_RESOLVED_TAPPED,
    ...
    PUSH_NOTIFICATIONS_CARD_VIEW,
    PUSH_NOTIFICATIONS_SETUP_INTRODUCTION_VIEW,
    PUSH_NOTIFICATIONS_SETUP_INTRODUCTION_BUTTON_TAP,
    PUSH_NOTIFICATIONS_SETUP_INTRODUCTION_LINK_TAP,
    PUSH_NOTIFICATIONS_SETUP_INTRODUCTION_CLOSE,
    PUSH_NOTIFICATIONS_SETUP_INTRODUCTION_ERROR,
    PUSH_NOTIFICATIONS_SETUP_FLOW_SUCCESS,
    PUSH_NOTIFICATIONS_SETUP_FLOW_BUTTON_TAP,
    PUSH_NOTIFICATIONS_SETUP_FLOW_CLOSE,
    PUSH_NOTIFICATIONS_SETUP_FLOW_ERROR,
    ...
    WOO_PUSH_TOKEN_DELETE_SUCCESS,
    WOO_PUSH_TOKEN_DELETE_ERROR,
    WPCOM_DEVICE_DISABLE_PUSH_NOTIFICATIONS_SUCCESS,
    WPCOM_DEVICE_DISABLE_PUSH_NOTIFICATIONS_ERROR,
    WPCOM_DEVICE_ENABLE_PUSH_NOTIFICATIONS_SUCCESS,
    WPCOM_DEVICE_ENABLE_PUSH_NOTIFICATIONS_ERROR,
    ...
    NOTIFICATIONS_RATIONALE_DISMISS_TAPPED,
    PUSH_NOTIFICATION_OS_ALERT_ALLOWED,
    PUSH_NOTIFICATION_OS_ALERT_DENIED,
    ...
    PRODUCT_CREATION_AI_GENERATED_NAME_DESCRIPTION_OPTIONS,
    ...
    PRODUCT_CREATION_AI_STARTED_PACKAGE_PHOTO_SELECTION_FLOW,
    PRODUCT_CREATION_AI_TEXT_DETECTED,
    PRODUCT_CREATION_AI_TEXT_DETECTION_FAILED,
    PRODUCT_CREATION_AI_UNDO_EDIT_TAPPED,
    ...
    CONNECTIVITY_TOOL_TECHNICAL_DETAILS_TAPPED,
    ...
    // Google for Woo
    GOOGLEADS_ENTRY_POINT_DISPLAYED,
    GOOGLEADS_ENTRY_POINT_TAPPED,
    ...
    // Custom Fields
    CUSTOM_FIELDS_LIST_LOADED,
    CUSTOM_FIELD_TAPPED,
    ADD_CUSTOM_FIELD_TAPPED,
    SAVE_CUSTOM_FIELD_TAPPED,
    CUSTOM_FIELDS_SAVED_SUCCESSFULLY,
    CUSTOM_FIELDS_SAVING_FAILED,
    CUSTOM_FIELD_EDITOR_LOADED,
    CUSTOM_FIELD_EDITOR_PICKER_TAPPED,
