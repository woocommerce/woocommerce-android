...
enum class AnalyticsEvent(val siteless: Boolean = false) {
    ...
    ORDER_LIST_AUTOMATIC_TIMEOUT_RETRY,
    ORDER_LIST_TOP_BANNER_TROUBLESHOOT_TAPPED,
    ...
    SITE_CREATION_STORE_READY_ALERT_DISPLAYED(siteless = true),
    SITE_CREATION_STORE_READY_ALERT_SWITCH_STORE_TAPPED(siteless = true),
