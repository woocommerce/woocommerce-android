...
class DataStoreRemoteConfigRepository @Inject constructor(
    ...
    companion object {
        ...
        const val PERFORMANCE_MONITORING_SAMPLE_RATE_KEY = "performance_monitoring_sample_rate_key"
    }
    ...
    override fun observePerformanceMonitoringSampleRate(): Flow<Double> {
        return dataStore.data.map { preferences ->
            preferences[doublePreferencesKey(PERFORMANCE_MONITORING_SAMPLE_RATE_KEY)] ?: 0.0
        }
    }

    override suspend fun updatePerformanceMonitoringSampleRate(performanceMonitoringSampleRate: Double) {
        dataStore.edit { preferences ->
            preferences[doublePreferencesKey(PERFORMANCE_MONITORING_SAMPLE_RATE_KEY)] = performanceMonitoringSampleRate
        }
    }
}
