...
import com.woocommerce.android.ui.prefs.cardreader.connect.CardReaderConnectDialog
...
class OrderDetailFragment : BaseFragment(R.layout.fragment_order_detail), OrderProductActionListener {
    ...
    private fun setupResultHandlers(viewModel: OrderDetailViewModel) {
        ...
        handleResult<Boolean>(CardReaderConnectDialog.KEY_CONNECT_TO_READER_RESULT) { connected ->
