...
@Module
abstract class RefundByItemsModule {
    @Module
    companion object {
        @JvmStatic
        @Provides
        fun provideDefaultArgs(fragment: RefundByItemsFragment): Bundle? {
            return fragment.parentFragment?.arguments
        }

        @JvmStatic
        @Provides
        fun provideSavedStateRegistryOwner(fragment: RefundByItemsFragment): SavedStateRegistryOwner {
