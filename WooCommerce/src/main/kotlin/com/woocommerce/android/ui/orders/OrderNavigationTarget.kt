...
sealed class OrderNavigationTarget : Event() {
    ...
    data class ViewOrderFulfillInfo(val orderId: Long, val localOrderId: Int) : OrderNavigationTarget()
    ...
    data class StartSimplePaymentCardReaderFlow(val orderId: Long) : OrderNavigationTarget()
