...
import com.woocommerce.android.databinding.DialogCardReaderConnectBinding
...
@AndroidEntryPoint
class CardReaderConnectFragment : DialogFragment(R.layout.dialog_card_reader_connect) {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        val binding = DialogCardReaderConnectBinding.bind(view)
        initMultipleReadersFoundRecyclerView(binding)
        initObservers(binding)
    }

    private fun initMultipleReadersFoundRecyclerView(binding: DialogCardReaderConnectBinding) {
    ...
    private fun initObservers(binding: DialogCardReaderConnectBinding) {
        observeEvents()
        observeState(binding)
        setupResultHandlers(viewModel)
    }

    private fun observeState(binding: DialogCardReaderConnectBinding) {
     ...
     */
    private fun moveToReaderFoundState(binding: DialogCardReaderConnectBinding, viewState: ViewState) {
    ...
    private fun moveToState(binding: DialogCardReaderConnectBinding, viewState: ViewState) {
    ...
    private fun updateMultipleReadersFoundRecyclerView(
        binding: DialogCardReaderConnectBinding,
        viewState: ViewState
    ) {
