package com.woocommerce.android.ui.products.media
...
import com.woocommerce.android.databinding.FragmentMediaUploadErrorsBinding
import com.woocommerce.android.extensions.takeIfNotEqualTo
import com.woocommerce.android.ui.base.BaseFragment
import dagger.hilt.android.AndroidEntryPoint

@AndroidEntryPoint
class MediaUploadErrorListFragment : BaseFragment(R.layout.fragment_media_upload_errors) {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        val binding = FragmentMediaUploadErrorsBinding.bind(view)
    ...
    private fun setupObservers(viewModel: MediaUploadErrorListViewModel) {
        viewModel.mediaUploadErrorList.observe(viewLifecycleOwner, Observer {
