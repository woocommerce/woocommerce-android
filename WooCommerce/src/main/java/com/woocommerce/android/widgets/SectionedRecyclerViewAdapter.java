...
import static com.woocommerce.android.widgets.Section.State;
...
public class SectionedRecyclerViewAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public SectionedRecyclerViewAdapter() {
        ...
        mSectionViewTypeNumbers = new HashMap<>();
    }
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        for (Map.Entry<String, Integer> entry : mSectionViewTypeNumbers.entrySet()) {
    ...
    public void addSection(String tag, Section section) {
        ...
        this.mSectionViewTypeNumbers.put(tag, mViewTypeCount);
    ...
    public int getItemViewType(int position) {
        ...
        for (Map.Entry<String, Section> entry : mSections.entrySet()) {
            ...
            // check if position is in this section
            if (position >= currentPos && position <= (currentPos + sectionTotal - 1)) {
                int viewType = mSectionViewTypeNumbers.get(entry.getKey());
     ...
     * header to mVisible with {@link Section#setHasHeader}.
     *
     * @param tag unique identifier of the section
     */
     ...
     * footer to mVisible with {@link Section#setHasFooter}.
     *
     * @param tag unique identifier of the section
     */
