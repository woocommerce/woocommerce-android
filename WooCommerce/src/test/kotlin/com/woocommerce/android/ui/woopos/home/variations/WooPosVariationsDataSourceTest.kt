...
//
//    private val varationsHandler: VariationListHandler = mock()
...
//        // GIVEN
//        val productId = 1L
//        whenever(varationsHandler.canLoadMore(5)).thenReturn(true)
//        whenever(varationsHandler.getVariationsFlow(productId)).thenReturn(flowOf(variationsSampleProductVariations))
...
//
//        whenever(
//            varationsHandler.fetchVariations(
//                productId,
//                forceRefresh = true,
//                mapOf(
...
//        val productId = 1L
//        whenever(varationsHandler.canLoadMore(5)).thenReturn(true)
//        whenever(varationsHandler.getVariationsFlow(productId)).thenReturn(
...
//        whenever(varationsHandler.loadMore(productId)).thenReturn(Result.success(Unit))
//        val sut = WooPosVariationsDataSource(
//            varationsHandler,
//            variationsCache,
//            WooPosVariationsTypesFilterConfig(),
...
//        val productId = 1L
//        whenever(varationsHandler.canLoadMore(5)).thenReturn(true)
//        whenever(varationsHandler.getVariationsFlow(productId)).thenReturn(flowOf(emptyList()))
//        val exception = Exception("Remote load failed")
//        whenever(
//            varationsHandler.fetchVariations(
//                productId,
...
//        whenever(varationsHandler.canLoadMore(5)).thenReturn(true)
//        whenever(varationsHandler.getVariationsFlow(productId)).thenReturn(flowOf(emptyList()))
//        whenever(varationsHandler.fetchVariations(productId, forceRefresh = false)).thenReturn(Result.success(Unit))
//        whenever(variationsCache.get(productId)).thenReturn(emptyList())
//        val sut = WooPosVariationsDataSource(
//            varationsHandler,
//            variationsCache,
...
//            )
//        )
//        whenever(varationsHandler.fetchVariations(productId, forceRefresh = true)).thenReturn(Result.success(Unit))
//        whenever(variationsCache.get(productId)).thenReturn(variationsSampleProducts)
//        val sut = WooPosVariationsDataSource(
//            varationsHandler,
//            variationsCache,
