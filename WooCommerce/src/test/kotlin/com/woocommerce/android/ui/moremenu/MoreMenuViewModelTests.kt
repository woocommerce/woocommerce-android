...
class MoreMenuViewModelTests : BaseUnitTest() {
    ...
    fun `when building state, then payments icon displayed`() = testBlocking {
        ...
        // THEN
        val paymentsButton = states.last().generalMenuItems.first { it.text == R.string.more_menu_button_payments }
    ...
    fun `when building state, then reviews icon displayed`() = testBlocking {
        ...
        // THEN
        val reviewsButton = states.last().generalMenuItems.first { it.text == R.string.more_menu_button_reviews }
