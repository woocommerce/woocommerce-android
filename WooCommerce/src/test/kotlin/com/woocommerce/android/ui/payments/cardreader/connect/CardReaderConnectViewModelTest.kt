...
import com.woocommerce.android.ui.payments.cardreader.connect.CardReaderConnectViewModelTest.ScanResult.FAILED
import com.woocommerce.android.ui.payments.cardreader.connect.CardReaderConnectViewModelTest.ScanResult.MULTIPLE_READERS_FOUND
...
class CardReaderConnectViewModelTest : BaseUnitTest() {
    ...
    fun setUp() = testBlocking {
        viewModel = initVM()
        whenever(appPrefs.getReaderOptionsSelected()).thenReturn(
